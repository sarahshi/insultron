...
modern_adjective=['annoying', 'irritating', 'infuriating', 'tiring', 'vexing', 'exasperating', 'unpleasant', 'hideous', 'repulsive', 'repugnant', 'grotesque', 'misshapen', 'disagreeable', 'nasty', 'vile', 'rotten', 'spiteful', 'vicious', 'reprehensible', 'unpleasant', 'homely', 'butt-ugly', 'fugly', 'ignorant', 'dense', 'unintelligent', 'foolish', 'dull-witted', 'simpleminded', 'vacuous', 'vapid', 'idiotic', 'imbecilic', 'obtuse', 'doltish', 'offensive']
  
modern_noun=['monkey', 'salami', 'taco', 'goblin', 'catfish', 'harpy', 'monster', 'pirate', 'chipotle burrito', 'biscuit', 'hotdog', 'loaf', 'freckle', 'kernel', 'elf', 'pig', 'patrick', 'alien', 'demon', 'devil', 'turkey', 'snake', 'dog', 'pee', 'rotted cheese']  
